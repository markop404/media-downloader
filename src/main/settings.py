...
class Settings(QSettings):
    ...
    CONSTANT_SETTTINGS = {
        ...
        "status_label_icons": {
            "download_failed": QIcon(QIcon.fromTheme("window-close")),
            "download_cancelled": QIcon(QIcon.fromTheme("window-close")),
            "download_finished": QIcon(QIcon.fromTheme("emblem-default")),
            "cancelling_download": QIcon(QIcon.fromTheme("window-close")),
            "downloading": QIcon(QIcon.fromTheme("emblem-downloads")),
            "extracting_urls": QIcon(QIcon.fromTheme("view-refresh")),
            "data_pull_failed": QIcon(QIcon.fromTheme("window-close")),
            "data_pull_cancelled": QIcon(QIcon.fromTheme("window-close")),
            "data_pull_finished": QIcon(QIcon.fromTheme("emblem-default")),
            "cancelling_data_pull": QIcon(QIcon.fromTheme("window-close")),
            "pulling_data": QIcon(QIcon.fromTheme("view-refresh")),
            "converting": QIcon(QIcon.fromTheme("emblem-downloads")),
            "no_internet": QIcon(QIcon.fromTheme("network-offline")),
        },
        "tab_text": {
        ...
        "tab_icons": {
            ...
            "pulling_data": QIcon(QIcon.fromTheme("view-refresh")),
            "converting": QIcon(QIcon.fromTheme("emblem-downloads")),
            "no_internet": QIcon(QIcon.fromTheme("window-close")),
        },
        "window_titles": {
