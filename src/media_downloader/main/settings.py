...
class Settings(QSettings):
    ...
    CONSTANT_SETTTINGS = {
        ...
        "status_label_icons": {
            ...
            "download_cancelled": QIcon(QIcon.fromTheme("list-remove")),
            "download_finished": QIcon(QIcon.fromTheme("emblem-default")),
            "cancelling_download": QIcon(QIcon.fromTheme("list-remove")),
            "downloading": QIcon(QIcon.fromTheme("emblem-downloads")),
            "extracting_urls": QIcon(QIcon.fromTheme("view-refresh")),
            "data_pull_failed": QIcon(QIcon.fromTheme("list-remove")),
            "data_pull_cancelled": QIcon(QIcon.fromTheme("list-remove")),
            "data_pull_finished": QIcon(QIcon.fromTheme("emblem-default")),
            "cancelling_data_pull": QIcon(QIcon.fromTheme("list-remove")),
        ...
        "tab_icons": {
            ...
            "pulling_data": QIcon(QIcon.fromTheme("view-refresh")),
            "converting": QIcon(QIcon.fromTheme("emblem-downloads")),
            "no_internet": QIcon(QIcon.fromTheme("list-remove")),
        },
        "window_titles": {
