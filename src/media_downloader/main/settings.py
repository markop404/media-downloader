...
class Settings(QSettings):
    ...
    CONSTANT_SETTTINGS = {
        ...
        "status_label_icons": {
            "download_failed": ICONS["list-remove"],
            "download_cancelled": ICONS["list-remove"],
            "download_finished": ICONS["emblem-default"],
            "cancelling_download": ICONS["media-playback-stop"],
            "downloading": ICONS["emblem-downloads"],
            "extracting_urls": ICONS["view-refresh"],
            "data_fetch_failed": ICONS["list-remove"],
            "data_fetch_cancelled": ICONS["list-remove"],
            "data_fetch_finished": ICONS["emblem-default"],
            "cancelling_data_fetch": ICONS["media-playback-stop"],
            "fetching_data": ICONS["view-refresh"],
            "converting": ICONS["emblem-downloads"],
            "no_internet": ICONS["network-offline"],
        },
        "tab_text": {
