...
class Settings(QSettings):
    ...
    CONSTANT_SETTTINGS = {
        ...
        "status_label_icons": {
            "download_failed": QIcon(QIcon.fromTheme("process-stop")),
            "download_cancelled": QIcon(QIcon.fromTheme("process-stop")),
            "download_finished": QIcon(QIcon.fromTheme("emblem-default")),
            "cancelling_download": QIcon(QIcon.fromTheme("process-stop")),
            "downloading": QIcon(QIcon.fromTheme("emblem-downloads")),
            "extracting_urls": QIcon(QIcon.fromTheme("view-refresh")),
            "data_pull_failed": QIcon(QIcon.fromTheme("process-stop")),
            "data_pull_cancelled": QIcon(QIcon.fromTheme("process-stop")),
            "data_pull_finished": QIcon(QIcon.fromTheme("emblem-default")),
            "cancelling_data_pull": QIcon(QIcon.fromTheme("process-stop")),
        ...
        "tab_icons": {
            ...
            "pulling_data": QIcon(QIcon.fromTheme("view-refresh")),
            "converting": QIcon(QIcon.fromTheme("emblem-downloads")),
            "no_internet": QIcon(QIcon.fromTheme("process-stop")),
        },
        "window_titles": {
