...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.versionLabel.setText(QCoreApplication.translate("aboutDialog", u"v3.5.0 &nbsp;|&nbsp; <a href=\"https://downloader.markopejic.com/\" style=\"text-decoration: none;\">Website</a>", None))
